...
public class WXPayController {
    ...
    public Result createNative(@RequestParam Map<String, String> parameterMap) {
        Map resultMap = wxPayService.createNative(parameterMap);
        return new Result(true, StatusCode.OK, "Multi pay success",resultMap);
    }
        ...
        try {
            ...
            if ("SUCCESS".equals(map.get("return_code"))) {
                ...
                if ("SUCCESS".equals(result.get("result_code"))) {
                    ...
                    // 获取自定义数据中的attach-> exchange, routingKey
                    String attachString = map.get("attach");
                    Map<String, String> attach = JSON.parseObject(attachString, Map.class);
