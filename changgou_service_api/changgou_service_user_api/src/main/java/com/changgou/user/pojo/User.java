...
public class User implements Serializable {
	...
	private String authorizetion; // 权限信息
	...
	public String getAuthorizetion() {
		return authorizetion;
	}

	public void setAuthorizetion(String authorizetion) {
		this.authorizetion = authorizetion;
	}
}
